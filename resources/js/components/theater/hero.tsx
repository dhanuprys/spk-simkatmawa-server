...
export function TheaterHero({ films }: TheaterHeroProps) {
    ...
    return (
        <section className="relative flex h-[75vh] w-full items-end overflow-hidden bg-gradient-to-t from-black via-black/60 to-transparent pb-8 md:pb-12">
            ...
            <img
                src={`/storage/${featured.poster_landscape_file || featured.poster_portrait_file}`}
                alt={featured.title}
            ...
            />
            <div className="relative z-10 max-w-4xl min-w-full p-4 sm:min-w-auto md:p-8 lg:p-16">
